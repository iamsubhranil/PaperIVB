...
//#define GRAPH_ENABLE_TEST_FLOYD_WARSHALL // enable test for Floyd's and Warshall's algorithm
...
typedef void (*graph_process_linked_path_with_length)(LinkedNode *path, i64 length);
