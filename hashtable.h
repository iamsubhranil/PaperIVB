...
typedef enum { HF_DIVISION, HF_MIDSQUARE, HF_FOLDING } HashFunction;

typedef enum { PROBE_LINEAR, PROBE_QUADRATIC, PROBE_RANDOM } ProbingTechnique;

HashTable hashtable_create_open(siz table_size, HashFunction func);
HashTable hashtable_create_closed(siz table_size, HashFunction func,
